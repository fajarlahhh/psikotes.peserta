        ...
        <div class="col-xl-9">
          ...
          <div class="card">
            ...
            <div class="card-footer">
              <a class="btn btn-success mt-2" href="javascript:;" wire:click="submit('SS')">Sangat
                Setuju</a>&nbsp;&nbsp;
              <a class="btn btn-success mt-2" href="javascript:;" wire:click="submit('S')">Setuju</a>&nbsp;&nbsp;
              <a class="btn btn-success mt-2" href="javascript:;" wire:click="submit('TS')">Tidak
                Setuju</a>&nbsp;&nbsp;
              <a class="btn btn-success mt-2" href="javascript:;" wire:click="submit('STS')">Sangat
                Tidak Setuju</a>&nbsp;&nbsp;
            </div>
          </div>
