...
<head>
  ...
  <link href="/landingpage/css/variables.css" rel="stylesheet">
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <h1>PintarPsi<span>.com</span></h1>
      </a>

      <a class="btn-getstarted scrollto" href="/login">Login Di Sini</a>
      ...
      <div class="container">
        <div class="row justify-content-center gy-6">
          ...
          <div class="col-lg-5 col-md-8 text-center">
            <img src="/landingpage/img/hero-carousel/hero-carousel-1.svg" style="height: 300px" alt=""
              class="img-fluid img">
          </div>

          <div class="col-lg-9 text-center">
            <h2>Selamat datang di pintarpsi.com</h2>
